...
9. `01_CONSOLIDATED_AI_PROTOCOL.md` — consult for AI operating rules, precedence guidelines, and execution safeguards.
...
5. Plans, handoff material, checklists, and AI protocol documents.
6. This index and the audit, which are navigational and advisory.

`01_CONSOLIDATED_AI_PROTOCOL.md` defines operating rules and safeguards but does not override user instructions or applicable security and data requirements.
...
|---|---|---|---|---|---|
| `00_DOCUMENT_INDEX.md` | Navigation, loading order, priority, and maintenance map. | All | References every document in this register. | Current; updated. | Update whenever a document is added, removed, renamed, or reprioritized. |
...
| `01_CONSOLIDATED_AI_PROTOCOL.md` | AI operating rules, precedence guidelines, and execution safeguards. | AI, Arch, Dev | Merges and replaces legacy `01_MASTER_PROMPT.md`, `15_AI_AGENT_PLAYBOOK.md`, `20_SYSTEM_PROMPT.md`, and `21_AI_EXECUTION_PROTOCOL.md`. | Approved; consolidated. | Update during AI-policy revisions or workflow changes. |
...
flowchart TD
  ...
  CH --> AP[01 Consolidated AI Protocol]
  ...
  AUD -. audits .-> CK
  AUD -. audits .-> JS
  IDX -. indexes .-> CH & AP & DS & EA & CS & API & QA & AG & PRD & IP & SEC & OPS & DH & SDK & PERF & CK & AUD & JS
```
